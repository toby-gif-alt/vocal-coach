...
export function createTakeMetadata({
  ...
  return Object.freeze({
    ...
    partVoices: Object.freeze(Object.fromEntries(Object.entries(partVoices || {}).map(([id, value]) => [id, value === "synthetic-ah" ? "synthetic-ah" : "human"]))),
    guideVoice: guideVoice === "synthetic-ah" ? "synthetic-ah" : "human",
